...
public class Register {
	...
	public String toString() {
		return "Register [regid=" + regid + ", fname=" + fname + ", lname=" + lname + ", email=" + email + ", pass="
				+ pass + ", mobile=" + mobile + ", address=" + address + ", getRegid()=" + getRegid() + ", getFname()="
				+ getFname() + ", getLname()=" + getLname() + ", getEmail()=" + getEmail() + ", getPass()=" + getPass()
				+ ", getMobile()=" + getMobile() + ", getAddress()=" + getAddress() + ", getClass()=" + getClass()
